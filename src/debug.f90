...
module mod_debug
  ...
  contains
  !
  subroutine chk_helmholtz(lo,hi,dxci,dxfi,dyci,dyfi,dzci,dzfi,alpha,fp,fpp,bc,is_bound,c_or_f,diffmax)
    !
  ...
  subroutine chk_poisson(lo,hi,dxci,dxfi,dyci,dyfi,dzci,dzfi,fp,fpp,diffmax)
    !
